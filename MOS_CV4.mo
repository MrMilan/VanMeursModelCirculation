package MOS_CV4
  ...
  model RightHeart
    ...
    Modelica.Blocks.Interfaces.RealInput Tas annotation(Placement(visible = true, transformation(origin = {-48, 98}, extent = {{-20, -20}, {20, 20}}, rotation = -90)));
    Modelica.Blocks.Interfaces.RealInput T0 annotation(Placement(visible = true, transformation(origin = {-88, 34}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-94, 70}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
    ...
    Modelica.Blocks.Interfaces.RealInput PTH annotation(Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
    VentricularElastance ventricularElastance1 annotation(Placement(visible = true, transformation(origin = {38, 22}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    Modelica.Blocks.Interfaces.RealInput Tav annotation(Placement(visible = true, transformation(origin = {-12, 74}, extent = {{-14, -14}, {14, 14}}, rotation = 0)));
    Modelica.Blocks.Interfaces.RealInput Tvs annotation(Placement(visible = true, transformation(origin = {-15, 25}, extent = {{-19, -19}, {19, 19}}, rotation = 0)));
  ...
  equation
    ...
    connect(Tas, ventricularElastance1.Tas) annotation(Line(points = {{-48, 98}, {28, 98}, {28, 28}, {28, 28}}, color = {0, 0, 127}));
    connect(Tas, atrialElastance1.Tas) annotation(Line(points = {{-48, 98}, {-58, 98}, {-58, 58}, {-58, 58}}, color = {0, 0, 127}));
    ...
    connect(ventricularElastance1.Et, RightVentricle.Elastance) annotation(Line(points = {{47, 29}, {56, 29}, {56, -36}}, color = {0, 0, 127}));
    connect(T0, ventricularElastance1.T0) annotation(Line(points = {{-88, 34}, {-56.25, 34}, {-56.25, 16}, {27, 16}}, color = {0, 0, 127}));
